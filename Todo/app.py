...
# con.execute("insert into tasks values (3, 'assignment', '2021-05-18', 'Finished')")
# con.execute("insert into tasks values (4, 'workout', '2021-05-18', 'In Progress')")
# con.execute("insert into tasks values (5, 'clean', '2021-05-18', 'Not Started')")
